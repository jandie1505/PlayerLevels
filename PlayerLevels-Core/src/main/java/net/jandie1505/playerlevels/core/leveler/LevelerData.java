...
public class LevelerData implements net.jandie1505.playerlevels.api.core.level.LevelerData {
    ...
    public @NotNull Map<String, net.jandie1505.playerlevels.api.core.level.ReceivedReward> getReceivedRewards() {
