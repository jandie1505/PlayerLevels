 ...
 * This data is normally created by the reward creator for the specific reward type, like {@link net.jandie1505.playerlevels.core.rewards.types.CommandReward#createInterval(String, boolean, CommandReward.SenderType, int, int, int)}.<br/>
