 ...
 * This data is normally created by the reward creator for the specific reward type, like {@link net.jandie1505.playerlevels.rewards.types.CommandReward#createMilestone(String, boolean, CommandReward.SenderType, int)}.<br/>
 * It can be used to create events using {@link net.jandie1505.playerlevels.api.reward.RewardsManager#addMilestoneReward(RewardConfig, MilestoneRewardData)}.
